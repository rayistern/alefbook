...
%%% ---- Hebrew / RTL support via polyglossia ----
%%% MUST be loaded AFTER xcolor, graphicx, hyperref, fancyhdr, tikz, etc.
%%% because bidi (loaded by polyglossia) requires it.
...
\newcommand{\sedersection}[4]{%
  ...
  %% Hebrew title
  \begin{center}
    {\hebrewfonttitle\textcolor{sederblue}{\texthebrew{#1}}}\\[4pt]
...
%%% ---- Bilingual side-by-side (minipage-based, polyglossia-safe) ----
...
\newcommand{\subsedertitle}[2]{%
  \par\vspace{8pt}
  \begin{center}
    {\hebrewfontlarge\textcolor{sederblue}{\texthebrew{#1}}}\\[3pt]
...
\begin{center}
  \textcolor{sedergold}{\hebrewfonttitle\fontsize{36pt}{42pt}\selectfont\texthebrew{הַגָּדָה שֶׁל פֶּסַח}}
...
\begin{center}
  {\hebrewfontlarge\textcolor{sederblue}{\texthebrew{הַגָּדָה שֶׁל פֶּסַח}}}
...
\begin{center}
  ...
  \textcolor{sedergold}{\hebrewfontlarge\texthebrew{חַג כָּשֵׁר וְשָׂמֵחַ!}}
\end{center}
