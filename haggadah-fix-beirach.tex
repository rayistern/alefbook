...
%%% ---- Fonts ----
%%% Uses project fonts from templates/fonts/ directory
\usepackage{fontspec}
\setmainfont{MinionPro-Regular.otf}[
  Path=templates/fonts/,
  Ligatures=TeX
]
\setsansfont{DINNextLTPro-Bold.otf}[
  Path=templates/fonts/,
  BoldFont=DINNextLTPro-Black.otf,
  ItalicFont=DINNextLTPro-LightItalic.otf
]
\newfontfamily\hebrewfont[Path=templates/fonts/, Script=Hebrew, Scale=1.15]{SimpleCLM-Medium.ttf}
\newfontfamily\hebrewfontsans[Path=templates/fonts/, Script=Hebrew, Scale=1.1]{SecularOne-Regular.ttf}
\newfontfamily\hebrewfontlarge[Path=templates/fonts/, Script=Hebrew, Scale=1.5]{Yiddishkeit 2.0 AAA Bold.otf}
\newfontfamily\hebrewfonttitle[Path=templates/fonts/, Script=Hebrew, Scale=2.0]{Yiddishkeit 2.0 AAA Black.otf}
...
%% Provide a manual \texthebrew for inline use (polyglossia may provide one too)
...
\AddToShipoutPictureBG{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    %% Gold header rule (above header text, with padding)
    \draw[sedergold, line width=0.4pt]
      ([shift={(0.65in,-0.55in)}]current page.north west) --
      ([shift={(-0.65in,-0.55in)}]current page.north east);
    %% Gold footer rule
    \draw[sedergold, line width=0.3pt]
      ([shift={(0.65in,0.6in)}]current page.south west) --
      ([shift={(-0.65in,0.6in)}]current page.south east);
