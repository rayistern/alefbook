...
\newfontfamily\hebrewfont[Path=templates/fonts/, Script=Hebrew, Scale=1.15]{EFT_TEXTY OTP.ttf}
\newfontfamily\hebrewfontsans[Path=templates/fonts/, Script=Hebrew, Scale=1.1]{SecularOne-Regular.ttf}
\newfontfamily\hebrewfontlarge[Path=templates/fonts/, Script=Hebrew, Scale=1.5]{SimpleCLM-Medium.ttf}
\newfontfamily\hebrewfonttitle[Path=templates/fonts/, Script=Hebrew, Scale=2.0]{Yiddishkeit 2.0 AAA Bold.otf}
