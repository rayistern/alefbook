...
\newfontfamily\hebrewfontsanslarge[Script=Hebrew, Scale=1.5, Path=templates/fonts/]{SecularOne-Regular.ttf}
...
\newfontfamily\hebrewfontdisplay[Script=Hebrew, Scale=2.5, Path=templates/fonts/]{Yiddishkeit 2.0 AAA Regular.otf}
...
\AddToShipoutPictureBG{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \draw[sedergold, line width=0.3pt]
      ([shift={(0.65in,0.72in)}]current page.south west) --
      ([shift={(-0.65in,0.72in)}]current page.south east);
...
\newcommand{\sedersection}[4]{%
  ...
  %% Hebrew title
  \begin{center}
    {\hebrewfontlarge\textcolor{sederblue}{\beginR #1\endR}}\\[4pt]
...
\newcommand{\subsedertitle}[2]{%
  \par\vspace{8pt}
  \begin{center}
    {\hebrewfontsanslarge\textcolor{sederblue}{\beginR #1\endR}}\\[3pt]
