...
## Image uploads
- When you see \`[Uploaded: filename.png]\` it means the image is available at \`images/filename.png\`.
- Only insert it if the user explicitly asks.`
...
export async function editDocumentWithTool(params: {
  ...
  // Give the LLM the document + instruction
  const messages: any[] = [
