...
\newfontfamily\kidssteptitlefonthebrew[Script=Hebrew, Scale=1.5, Path=/usr/local/share/fonts/]{FredokaOne-Regular.otf}
...
\definecolor{sederblue}{HTML}{5478FF}
\definecolor{sedergold}{HTML}{FFE2AF}
\definecolor{sederwine}{HTML}{53CBF3}
\definecolor{sederlight}{HTML}{FFF8DE}
\definecolor{sederborder}{HTML}{D4D8F0}
...
\newcommand{\sedersection}[4]{%
  ...
  %% Titles (kids fonts)
  \begin{center}
    {\kidssteptitlefonthebrew\textcolor{sederblue}{\beginR #1\endR}}\\[4pt]
...
\newcommand{\subsedertitle}[2]{%
  \par\vspace{8pt}
  \begin{center}
    {\kidssteptitlefonthebrew\textcolor{sederblue}{\beginR #1\endR}}\\[3pt]
