...
%% No paracol — it conflicts with bidi RTL handling.
...
\newenvironment{bilingual}{%
  ...
  \begin{minipage}[t]{\bidiHebWidth}
    \begingroup\hebrewfont\TeXXeTstate=1\beginR
    \large\setstretch{1.4}\emergencystretch=3em\tolerance=9999\parindent=0pt\relax
    \usebox{\bidiHebBox}
    \endR\endgroup
  \end{minipage}%
  \par\vspace{2pt}%
