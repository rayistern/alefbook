...
\newfontfamily\hebrewfont[Script=Hebrew, Scale=1.15]{EFT_TEXTY OTP}
\newfontfamily\hebrewfontsans[Script=Hebrew, Scale=1.1]{FreeSans}
\newfontfamily\hebrewfontlarge[Script=Hebrew, Scale=1.5]{SimpleCLM}
\newfontfamily\hebrewfonttitle[Script=Hebrew, Scale=2.0]{Yiddishkeit 2.0 AAA}
...
%%% ---- Image placeholder command (kept for any remaining placeholders) ----
...
% Four Questions image removed — no matching illustration
...
% Dayeinu image removed — no matching illustration
