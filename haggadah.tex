...
%% No paracol — it conflicts with polyglossia/bidi RTL handling.
%% Side-by-side columns use minipage pairs instead (see bilingual env below).
...
%%% ---- Hebrew / RTL support (polyglossia + bidi) ----
%%% MUST be loaded after all other packages (bidi requirement)
\usepackage{polyglossia}
\setdefaultlanguage{english}
\setotherlanguage{hebrew}
%% polyglossia uses \hebrewfont (defined above) automatically for Hebrew text
%% provides \begin{hebrew}...\end{hebrew} and \texthebrew{} with proper RTL
...
\newcommand{\sedersection}[4]{%
  ...
  %% Hebrew title
  \begin{center}
    {\hebrewfonttitle\texthebrew{\textcolor{sederblue}{#1}}}\\[6pt]
...
%%% ---- Bilingual side-by-side (minipage-based, bidi-safe) ----
%%% Collects Hebrew and English in saveboxes, then places them side by side.
\newsavebox{\bidiHebBox}
\newsavebox{\bidiEngBox}
\newlength{\bidiColSep}
\setlength{\bidiColSep}{0.25in}
\newlength{\bidiHebWidth}
\newlength{\bidiEngWidth}
%% Hebrew = 54%, English = 46% of available width minus separator
\setlength{\bidiHebWidth}{0.54\textwidth}
\addtolength{\bidiHebWidth}{-0.5\bidiColSep}
\setlength{\bidiEngWidth}{0.46\textwidth}
\addtolength{\bidiEngWidth}{-0.5\bidiColSep}

\newenvironment{bilingual}{%
  \par\vspace{4pt}%
}{%
  %% Render: English on left, gold rule, Hebrew on right
  \noindent
  \begin{minipage}[t]{\bidiEngWidth}
    \setstretch{1.4}\emergencystretch=0.5em\normalsize
    \usebox{\bidiEngBox}
  \end{minipage}%
  \hfill
  {\color{sedergold}\vrule width 0.3pt}%
  \hfill
  \begin{minipage}[t]{\bidiHebWidth}
    \begin{hebrew}
    \hebrewfont\large\setstretch{1.4}\emergencystretch=1em\parindent=0pt\relax
    \usebox{\bidiHebBox}
    \end{hebrew}
  \end{minipage}%
  \par\vspace{2pt}%
...
\newenvironment{hebrewcol}{%
  \begin{lrbox}{\bidiHebBox}\begin{minipage}{\bidiHebWidth}%
}{%
  \end{minipage}\end{lrbox}%
}

\newenvironment{englishcol}{%
  \begin{lrbox}{\bidiEngBox}\begin{minipage}{\bidiEngWidth}%
}{%
  \end{minipage}\end{lrbox}%
}
...
\newcommand{\subsedertitle}[2]{%
  \par\vspace{8pt}
  \begin{center}
    {\hebrewfontlarge\texthebrew{\textcolor{sederblue}{#1}}}\\[3pt]
...
\begin{center}
  {\hebrewfonttitle\fontsize{36pt}{42pt}\selectfont\textcolor{sedergold}{\texthebrew{הַגָּדָה שֶׁל פֶּסַח}}}
...
\begin{center}
  {\hebrewfontlarge\texthebrew{\textcolor{sederblue}{הַגָּדָה שֶׁל פֶּסַח}}}
...
בִּרְשׁוּת מָרָנָן וְרַבָּנָן וְרַבּוֹתַי. נְבָרֵךְ (אֱלֹהֵינוּ) שֶׁאָכַלְנוּ מִשֶּׁלּוֹ:
\end{hebrewcol}
\begin{englishcol}
...
\subsedertitle{לא לנו}{Psalm 115}
...
\subsedertitle{נרצה}{Nirtzah --- Conclusion}
...
\begin{center}
  ...
  {\hebrewfontlarge\textcolor{sedergold}{\texthebrew{חַג כָּשֵׁר וְשָׂמֵחַ!}}}
\end{center}
