...
%%% paracol removed — conflicts with bidi RTL; using minipage+savebox instead
...
%%% Uses minipage + savebox to avoid paracol/bidi RTL conflicts.

%% Declare saveboxes and widths
...
%% Collect Hebrew content into a savebox
...
%% Collect English content into a savebox
...
%% Render both side-by-side: English left, Hebrew right
\newenvironment{bilingual}{\par\vspace{4pt}}{%
  \noindent
  \begin{minipage}[t]{\bidiEngWidth}
    \usebox{\bidiEngBox}
  \end{minipage}%
  \hfill{\color{sedergold}\vrule width 0.3pt}\hfill
