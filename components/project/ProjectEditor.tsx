          ...
          {pdfUrl && (
            <div className="relative shrink-0" ref={downloadMenuRef}>
              <button
                ...
                className="rounded-lg border border-purple-100 px-2 md:px-3 py-1.5 min-h-[44px] text-xs font-medium hover:bg-purple-50 hover:border-purple-200 transition-colors flex items-center gap-1.5 whitespace-nowrap"
                title="Download PDF"
              >
                <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              {showDownloadMenu && (
                <div className="absolute right-0 top-full mt-1 w-56 bg-white rounded-lg shadow-lg border border-purple-100 py-1 z-50">
                  <a
                    href={pdfUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-start gap-2.5 px-3 py-2 hover:bg-purple-50 transition-colors"
                  ...
                  >
                    ...
                    <div>
                      <div className="text-xs font-medium">Download PDF</div>
                      <div className="text-[10px] text-muted-foreground">Standard — for viewing &amp; sharing</div>
                    </div>
                  </a>
                  <a
                    href={bleedPdfUrl ?? '#'}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex items-start gap-2.5 px-3 py-2 transition-colors ${bleedPdfUrl ? 'hover:bg-purple-50' : 'opacity-40 pointer-events-none'}`}
                    onClick={() => setShowDownloadMenu(false)}
                  >
                    <svg className="w-4 h-4 mt-0.5 shrink-0 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
