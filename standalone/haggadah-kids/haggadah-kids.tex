...
\newfontfamily\kidstitlefont[Path=fonts/]{COOPBL.TTF}
\newfontfamily\kidsinstructionfont[Path=fonts/]{ACMESecretAgentBB_Reg.otf}
\newfontfamily\kidssteptitlefont[Path=fonts/]{FredokaOne-Regular.otf}
\newfontfamily\kidssteptitlefonthebrew[Script=Hebrew, Scale=1.5, Path=fonts/]{FredokaOne-Regular.otf}
